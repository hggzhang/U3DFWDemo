...
{
    public static string luaDir = Application.dataPath + "/Lua/LuaFramework/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Lua/LuaFramework/ToLua/Lua";        //tolua lua文件目录
